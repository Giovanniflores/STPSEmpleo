...
<title>Portal del Empleo :: Candidato Vinculado</title>
</head>
              ...
              <tr>
                <td>
					...
					<div id="registro_bienvenida" style="font-family: Tahoma, Geneva, sans-serif;margin: 0 40px 20px;padding: 20px 0;">
							...
							<xsl:value-of select="destinatario/nombre"/> ha iniciado contacto contigo para ocupar el puesto <xsl:value-of select="destinatario/tituloOfertaEmpleo"/>. 
							Para mayor información consulta la sección &quot;Empresas que me buscan&quot; en tu espacio para candidatos del Portal del Empleo.
							</p>
