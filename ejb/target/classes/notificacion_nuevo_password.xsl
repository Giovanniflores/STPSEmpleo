                ...
                <td style="padding: 25px">
	                ...
	                <p align="center">
		                  	<font face="Arial, Helvetica, sans-serif" color="#222222" size="2">
		                  		...
		                  		Para cambiar tu contraseña, <a href="{destinatario/encode}">inicia sesión</a> y actualiza los datos de tu perfil.<br />
		                  	</font>
		             </p>
	                 <p align="center">
		                  	<font face="Arial, Helvetica, sans-serif" color="#5F7A18" size="2">
