...
<title>Portal del Empleo :: Contratación Candidato</title>
</head>
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="right" valign="top" background="http://empleo.gob.mx/images/fnd_body-email.jpg">
              ...
              <tr>
                <td>
                	<img src="https://www.empleo.gob.mx/images/transp-email.gif" width="20" height="20" />
					...
					<div id="registro_bienvenida" style="font-family: Tahoma, Geneva, sans-serif;margin: 0 40px 20px;padding: 20px 0;">
						...
						El Portal del Empleo ha sido notificado que <xsl:if test="destinatario/tipoPersona='moral'"><xsl:text>la empresa </xsl:text></xsl:if><xsl:value-of select="destinatario/nombre"/> te ha aceptado para ocupar el puesto <xsl:value-of select="destinatario/tituloOfertaEmpleo"/>. 
                        Agradecemos tu confianza en los servicios ofrecidos por el Portal del Empleo. Te recordamos que en el Portal del Empleo encontrarás cursos de capacitación, asesoría laboral, información y tendencias sobre el mercado laboral.
						</p>
