          ...
          <td align="right" valign="top" background="http://empleo.gob.mx/images/fnd_body-email.jpg">
          	...
          	<table width="100%" border="0" cellspacing="6" cellpadding="0">
          		<tr>
                	...
                	<p align="left"><font face="Arial, Helvetica, sans-serif" color="#222222" size="2"><b>Saludos.</b></font></p>                	
                    <p align="left"><font face="Arial, Helvetica, sans-serif" color="#222222" size="2">Este es el reporte con los candidatos registrados a través del portal INFONAVIT</font></p>
                    <p align="left"><font face="Arial, Helvetica, sans-serif" color="#222222" size="2">de la fecha: <xsl:value-of select = "destinatario/fechaInicial" /> a <xsl:value-of select = "destinatario/fechaActual" /></font></p>
                    
                    <p><font face="Arial, Helvetica, sans-serif" color="#222222" size="2">
						  <b>Total de Candidatos registrados en este periodo:</b>
						  <xsl:value-of select="destinatario/totalCandidatos" />						  
				    </font></p> 
                    <p align="center">
                  	  <font face="Arial, Helvetica, sans-serif" color="#5F7A18" size="3">
                  		  Esta notificación se emitió por el Portal del Empleo.
                  	  </font>
                    </p>	                  
	                <p align="center">
	                  <font face="Arial, Helvetica, sans-serif" color="#5F7A18" size="3">
