...
public class OfertasPorAreaLaboralDAO extends TemplateDAO{
...
StringBuilder sqlString = new StringBuilder();
		...
		sqlString.append("AND OE.ID_AREA_LABORAL = ? ");
	...
	public List<OfertaBusquedaKioscoVO> obtenerOfertasPorAreaLaboral(long idAreaLaboral, long orderBy) throws SQLException {
		List<OfertaBusquedaKioscoVO> ofertas = new ArrayList<OfertaBusquedaKioscoVO>();
		Object[] parametros = {Constantes.ESTATUS.ACTIVO.getIdOpcion(), idAreaLaboral,Constantes.TIPO_PROPIETARIO.OFERTA.getIdTipoPropietario(), Constantes.CATALOGO_OPCION_OCUPACION, Constantes.CATALOGO_OPCION_ENTIDAD_FEDERATIVA};
