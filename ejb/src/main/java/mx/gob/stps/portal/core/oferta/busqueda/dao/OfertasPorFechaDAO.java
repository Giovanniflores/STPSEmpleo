...
public class OfertasPorFechaDAO extends TemplateDAO{
...
StringBuilder sqlString = new StringBuilder();
		...
		sqlString.append("AND (OE.FECHA_ALTA >= (SYSDATE-?) OR OE.FECHA_MODIFICACION >= (SYSDATE-?)) ");
	...
	public List<OfertaBusquedaKioscoVO> obtenerOfertasPorFecha(long idFecha, long orderBy) throws SQLException {
		List<OfertaBusquedaKioscoVO> ofertas = new ArrayList<OfertaBusquedaKioscoVO>();
		Object[] parametros = {Constantes.ESTATUS.ACTIVO.getIdOpcion(), idFecha,idFecha,Constantes.TIPO_PROPIETARIO.OFERTA.getIdTipoPropietario(), Constantes.CATALOGO_OPCION_OCUPACION, Constantes.CATALOGO_OPCION_ENTIDAD_FEDERATIVA};
