...
public class OfertasJovenesDAO extends TemplateDAO{
	...
	protected String getQuery() {
		...
		sqlString.append("AND OE.EDAD_MINIMA >=15 ");
		sqlString.append("AND OE.EDAD_MAXIMA <=29 ");
		sqlString.append("ORDER BY "+ORDER_BY);

		return sqlString.toString();
	}

	public List<OfertaBusquedaKioscoVO> obtenerOfertasJovenes(long idEntidad, long orderBy, long idMunicipio) throws SQLException {
