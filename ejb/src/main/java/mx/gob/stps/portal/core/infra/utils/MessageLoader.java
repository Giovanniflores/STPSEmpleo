...
import static mx.gob.stps.portal.core.infra.utils.Constantes.APPLICATION_MESSAGES;
...
public final class MessageLoader {
	...
	private Properties initProperties() throws Exception {
		...
		InputStream in = this.getClass().getClassLoader().getResourceAsStream(APPLICATION_MESSAGES);
		properties.load(in);
		return properties;
	}
}