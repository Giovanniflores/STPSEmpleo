/****
 Last Modified: 27/04/11 11:27:34 
...
function GoogieSpell(img_dir, server_url) {
    ...
    this.lang_chck_spell = "Revisar ortograf&#237;a";
    this.lang_revert = "Regresar a";
    this.lang_close = "Cerrar";
    this.lang_rsm_edt = "Terminar revisi&#243;n";
    this.lang_no_error_found = "No se encontraron errores";
    this.lang_no_suggestions = "Sin sugerencias";
...
GoogieSpell.prototype.showErrorWindow = function(elm, id) {
    ...
    list.appendChild(AJS.TR(AJS.TD({'style': 'text-align: left; font-size: 1px; height: 1px; margin: 0; padding: 0;'}, link)));
    link.focus();
}
...
GoogieSpell.prototype.createChangeLangPic = function() {
    var img = AJS.IMG({'src': this.img_dir + 'change_lang.png', 'alt': "Change language"});
...
GoogieSpell.prototype.createSpellDiv = function() {
    ...
    return AJS.SPAN(chk_spell, " ", spell_img);
}
