...
<form name="contrasenaForm" id="contrasenaForm" method="post"
	...
	<div class="miEspacio formApp">
		...
		<div class="col-md-5" style="float:none;margin:auto;text-align:center">
			...
			<div class="row">
			<div class="col-md-12">
				<input type="text" name="correo" id="correo" size="40" maxlength="65"
						    	   dojoType="dijit.form.ValidationTextBox" class="form-control"
						    	   required="true" regExp="${regexpmail}"
									invalidMessage="Correo electronico invalido, verificar captura." missingMessage="El correo es requerido."/>
									<p>&nbsp;</p>
			</div>
			</div>
			...
			<div class="form_nav"><p>&nbsp;</p>
				<input type="button" id="btnAceptar" value="Aceptar" class="boton_naranja  bt_grande"
					onclick="javascript:mostrarDatos();" /> <input type="button"
					value="Cerrar" class="boton_naranja  bt_grande"
