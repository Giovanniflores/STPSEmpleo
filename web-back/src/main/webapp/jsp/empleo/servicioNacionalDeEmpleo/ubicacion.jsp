...
<abbr title="C&oacute;digo Postal">C.P.</abbr> 06820<abbr title="Ciudad de M&eacute;xico"></abbr></p>
  ...
  Deleg, Cuauht&eacute;moc, <abbr title="C&oacute;digo Postal">C.P.</abbr> 06820</p>
						...
						<div class="col-sm-6">
							<p><strong>Correo electr&oacute;nico</strong><br />
						<!--    <a href="mailto:sol_qe@yahoo.com.mx">sol_qe@yahoo.com.mx</a>-->
						N D
						<br /></p>
						</div>
					</div>
    ...
    &nbsp;</p>
						...
						<div class="col-sm-6">
							 <p><strong>Responsable</strong><br />
							 María Arellano González<br />
							 Encargada de Unidad Delegacional del Servicio de Empleo</p>
						</div>
						<div class="clearfix"></div>
						<div class="col-sm-6">
							 <p><strong>Tel&eacute;fono(s) y extensi&oacute;n </strong><br />
						...
						<div class="col-sm-6">
							<p><strong>Correo electr&oacute;nico</strong><br />
						    <a href="mailto:mary_arellano10@hotmail.com">mary_arellano10@hotmail.com</a><br /></p>
						</div>
					</div>
				</div>
			</div><!-- end panel -->
			...
			<div class="panel panel-default filtro ciudaddemexico">
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-sm-6">
							 <p><strong>Responsable</strong><br />
							 Julio Eusebio Díaz Castillo<br />
							 Encargado de Unidad Delegacional del Servicio de Empleo</p>
						</div>
						<div class="clearfix"></div>
						<div class="col-sm-6">
							 <p><strong>Tel&eacute;fono(s) y extensi&oacute;n </strong><br />
						...
						<div class="col-sm-6">
						    ...
						    <a href="mailto:julio_coord_azc@outlook.es">julio_coord_azc@outlook.es</a><br /></p>
						</div>
					</div>
				</div>
			</div><!-- end panel -->
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-sm-6">
							...
							Erika Alejandra Gómez Ramírez<br />
							 Encargado de Unidad Delegacional del Servicio de Empleo</p>
						</div>
						<div class="clearfix"></div>
						<div class="col-sm-6">
	...
	Calz. San Antonio Abad No.32, (Planta Baja), <abbr title="Colonia">Col. </abbr>Tr&aacute;nsito, <abbr title="C&oacute;digo Postal"> C.P.</abbr> 06820.
						...
						<div class="col-sm-6">
							 ...
							 Christian Vallarta González<br /> 
					Encargado de Unidad Delegacional del Servicio de Empleo</p>
						</div>
						<div class="clearfix"></div>
						<div class="col-sm-6">
			...
			<div class="panel panel-default filtro ciudaddemexico">
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-sm-6">
							<p><strong>Correo electr&oacute;nico</strong><br />
						    <a href="mailto:patyelvira@hotmail.com">patyelvira@hotmail.com</a></p>
						</div>
					</div>
				</div>
			</div><!-- end panel -->
    ...
    &nbsp;</p>
						...
						<div class="col-sm-6">
						    ...
						    <a href="mailto:hrodriguez29@hotmail.com">hrodriguez29@hotmail.com</a></p>
						</div>
					</div>
				</div>
			</div><!-- end panel -->
			...
			<div class="panel panel-default filtro ciudaddemexico">
				...
				<div class="panel-body">
					...
					<!---<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<p><strong>Correo electr&oacute;nico</strong><br />
						    <a href="mailto:hortizm@cdmx.gob.mx">hortizm@cdmx.gob.mx</a></p>
						</div>
					</div>
				</div>
			</div><!-- end panel -->
			...
			<div class="panel panel-default filtro ciudaddemexico">
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-sm-6">
							<p><strong>Correo electr&oacute;nico</strong><br />
						    <a href="mailto:unidad.malta@gmail.com">unidad.malta@gmail.com</a><br />
    ...
    &nbsp;</p>
						...
						<div class="col-sm-6">
							 <p><strong>Tel&eacute;fono(s) y extensi&oacute;n </strong><br />
						    3000 2100 Ext. 1810, 1811<br />
						    5842 6123<br />
						    5842 1731</p>
						</div>
						<div class="col-sm-6">
							<p><strong>Correo electr&oacute;nico</strong><br />						   
						    <a href="mailto:udsetlh@gmail.com">udsetlh@gmail.com</a><br />
			...
			<div class="panel panel-default filtro ciudaddemexico">
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-sm-6">
							 <p><strong>Responsable</strong><br />
							 Sandra Adriana José Carrasco<br />
							 Encargada de Unidad Delegacional del Servicio de Empleo</p>
						</div>
						<div class="clearfix"></div>
						<div class="col-sm-6">
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-sm-6">
						    ...
						    <a href="mailto:manuel_9658@hotmail.com">manuel_9658@hotmail.com</a></p>
						</div>
					</div>
				</div>
			</div><!-- end panel -->
