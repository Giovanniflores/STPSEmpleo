...
<t:publicTemplate>
	<jsp:attribute name="titulo">Mecanismo de Movilidad Laboral interna y externa</jsp:attribute>
    ...
    <div class="row">
      <div class="col-sm-12">
        <ol class="breadcrumb">
          ...
          <li class="active">Mecanismo de Movilidad Laboral interna y externa</li>
        </ol>
      </div>
    </div>
    <!-- /div ruta_navegacion -->
        ...
        <div class="clearfix"></div>
		 ...
		 <div class="panel">
          <div class="panel-body">
			<h2 class="titulosh2">Mecanismo de Movilidad Laboral interna y externa</h2>
