...
<t:publicTemplate>
	...
	<jsp:attribute name="descripcionRedSocial">
		Detalle de la oferta. Farmacólogo
	</jsp:attribute>
	<jsp:body>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="page-header">
				<h3>Detalle de la oferta <small>Farmacólogo</small></h3>
			</div>
		</div>
						...
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>Con estudios completos como Farmacólogo.</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>A partir de que se cuente con el reconocimiento y el permiso pleno para trabajar, es requerido un nivel B2 en interacción general y un C-1 en lenguaje como farmacólogo.</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>Es muy deseable la experiencia laboral, aunque estamos abiertos en dar la bienvenida a recién graduados.</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>Resistencia, flexibilidad y adaptabilidad como parte de los valores personales, así como buenos modales, experiencia en supervisión de calidad, con licencia de manejar tipo B.</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
...
Inicio de contrato: Tan pronto como sea posible.
				...
				<div class="col-sm-12">
					...
					<div class="panel panelOfferOdd">
						<div class="panel-body">Trabaja en farmacias y otras áreas disponibles para los farmacólogos.</div>
					</div>
					<div class="panel panelOffer">
						<div class="panel-body">Posibilidad de medio tiempo o tiempo completo.</div>
					</div>
					<div class="panel panelOfferOdd">
						<div class="panel-body">El mercado laboral para el puesto va en aumento para candidatos internacionales en el área debido a los cambios demográficos y población en retiro para los próximos 10 años.</div>
					</div>
					<div class="panel panelOffer">
						<div class="panel-body">Actitud positiva y Servicio de Orientación.</div>
					</div>
					<div class="panel panelOfferOdd">
						<div class="panel-body">Interesado en trabajar y vivir en Alemania.</div>
					</div>
				</div>
				<div class="col-sm-12">
					<div class="panel panelOfferDetalle">
						<div class="panel-body">
							<span>*Salario promedio, 36.000-61.200€ (salario bruto, depende del área geográfica en Alemania, lugar de Trabajo y experiencia profesional).</span>
