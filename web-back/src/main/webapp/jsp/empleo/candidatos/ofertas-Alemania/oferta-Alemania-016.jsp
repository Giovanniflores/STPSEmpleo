...
<t:publicTemplate>
	...
	<jsp:attribute name="descripcionRedSocial">
		Detalle de la oferta. Científicos de Datos / Analistas de Datos
	</jsp:attribute>
	<jsp:body>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="page-header">
				<h3>Detalle de la oferta <small>Científicos de Datos / Analistas de Datos</small></h3>
			</div>
		</div>
			...
			<div class="row">
						...
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>Científicos de Datos / Analistas de Datos</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>Título universitario en Ciencias de Datos, Ciencias computacionales, ingeniería de software.</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>Nivel básico a Bueno es una ventaja.</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>Inglés – fluido /de nivel profesional, idiomas adicionales son una ventaja.</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>En el campo del análisis de datos / ciencias de datos / extracción de datos.</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>Habilidades de programación son una ventaja.</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
				...
				<div class="col-sm-12">
					...
					<div class="panel panelOfferOdd">
						<div class="panel-body">La Ciencia de Datos es un campo interdisciplinario que trata de métodos, procesos y sistemas científicos usados para extraer el conocimiento o las observaciones sobre los datos de varias maneras, ya sean estructuradas o no.</div>
					</div>
					<div class="panel panelOfferOdd">
						<div class="panel-body">El análisis de datos es el proceso de inspeccionar, limpiar, transformar y modelar datos con el fin de descubrir información útil, sugerir conclusiones y apoyar la toma de decisiones.</div>
					</div>
					<div class="panel panelOfferOdd">
						<div class="panel-body">Completamente cualificado y con título universitario en Ciencias de Datos u otros estudios relevantes.</div>
					</div>
					<div class="panel panelOffer">
						<div class="panel-body">Conocimiento de estructuras de bases de datos (Access, SQL, Oracle etc.).</div>
					</div>
					<div class="panel panelOfferOdd">
						<div class="panel-body">Conocimiento en estadísticas de datos.</div>
					</div>
					<div class="panel panelOffer">
						<div class="panel-body">Conocimiento en la visualización de datos.</div>
					</div>
					<div class="panel panelOfferOdd">
