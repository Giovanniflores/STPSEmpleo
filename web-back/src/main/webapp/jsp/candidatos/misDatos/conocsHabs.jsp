...
//---------------------------------------------------------------------------------------------------------
    ...
    function validatePrincipalKnowledge() {
	...
	function doAddKnowledge() {
    	if(isValidKnowledge()) {
	    	...
	    	dojo.xhrGet({
				url: 'escolaridad.do?method=saveAddKnowledge&idExperienciaSelectAdd='+idExperienciaSelectAdd+'&descripcionConAdd='+descripcionConAdd+'&conocimientoAdd='+conocimientoAdd,
	...
	function deleteKnowledge(idKnow) {
		...
		dojo.xhrGet({url: 'escolaridad.do?method=deleteKnowledge&idKnow='+idKnow, form:'escolaridadForm', sync: true, timeout:180000, 
					  load: function(data) {
						  clearWidgetsAndAddHtml('idConocimientosBloque',data);
						estableceCorrectores();
					  }});
	...
	<div id="conocimientosadd" class="conocimientos bloque color_bloque" style="display:none">
        	...
        	<div class="margin_top_10">
        		<div class="grid1_3 fl">
                	...
                	<input class="sugerido" type="text" name="conocimientoAdd" id="conocimientoAdd" value="" style="width:25em;" maxlength="50" regExp="^[\w\d\s\.&aacute;&eacute;&iacute;&oacute;&uacute;&Aacute;&Eacute;&Iacute;&Oacute;&Uacute;&Ntilde;&ntilde;]{1,50}$" 
	        		dojoType="dijit.form.ValidationTextBox" required="true" missingMessage="Debe indicar el conocimiento." invalidMessage="Valor no permitido" />
            	</div>
            	<div class="grid1_3 fl">
