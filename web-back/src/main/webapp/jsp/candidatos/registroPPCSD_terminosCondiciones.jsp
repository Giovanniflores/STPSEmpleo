...
<script type="text/javascript">
	...
	function sendTerminosYCondiciones(){
...
<form class="formApp" name="form" id="form" method="post" action="registroCandidatoPPCSD.do" dojoType="dijit.form.Form">
        ...
        <div class="form_edge">
            ...
            <div class="terminos_1 margin_top_10">
                ...
                <div>
					...
					<input type="hidden" name="method" id="method" value="sendTerminosCondiciones"/>
					<input type="hidden" name="curp" value="${requestScope['curp']}"/>					                    
					<input type="hidden" name="nss" value="${requestScope['nss']}"/>
					<input type="hidden" name="idCandidato" value="${requestScope['idCandidato']}"/>					
    ...
    <div class="form_nav">						
	    <input type="button" value="Continuar" onclick="sendTerminosYCondiciones();">
    </div>
</form>
