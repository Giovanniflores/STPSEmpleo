...
<script type="text/javascript">
	...
	// Variables para gestionar la respuesta a la validación de Curpo y NSS
			...
			{url: 'registro.do?method=continuaRegistroByCurp', form: 'registroCandidatoForm',
		  	   load: function(data){
							...
							if(res.result == NOTLOGGEDUSER_NOTREG){
					    		...
					    		showErrorMsg("Existen datos erróneos o faltantes.");
    ...
    function verificarDatosPersonales(){
  	...
  	function showMessageCurpDuplicado(resultExiste){
  		...
  		if (resultExiste == "nounico_ppc")
  			replaceDialogMsg("La CURP ya está registrada en el sistema e inscrita al Programa de Promoción y Colocación del Seguro de Desempleo (PPC-SE). Para ingresar al portal, puedes:", "msgCurpRegistrada");
		...
		<div id="porCurp" class="ctrl_02" style="display:none">
	        <div class="margin_top_30">
	            ...
	            <input type="text" id="curp"  name="curp" 
	               ...
	               regExp="${regexpcurp}" invalidMessage="CURP inválida, favor de verificar su captura." 
...
<div dojoType="dijit.Dialog" id="msgImmsNoDisponible" title="Error" draggable="false" style="display:none">
	<div class="msg_contain">
		<p>No se puede validar el NSS porque el servicio del IMSS no está disponible: por favor inténtelo de nuevo más tarde.</p>
	</div>
	<p class="form_nav">	
