...
<script type="text/javascript">
  ...
  function doSubmitPager(method) {
      ...
      dojo.xhrPost({url: 'ofertasMovilidadLaboral.do', form:'OfertasRecientesForm', timeout:180000, 
                    load: function(data) {
  ...
  function mostrarTodas(tipo, totReg) {
	...
	function doSubmitPagina(pagina, dif){
	   	...
	   	dojo.xhrPost({url: 'ofertasMovilidadLaboral.do?method=goToPage&goToPageNumber='+pagina, timeout:180000, 
...
<div class="row">
    ...
    <form name="OfertasRecientesForm" id="OfertasRecientesForm" action="ofertasMovilidadLaboral.do" method="post">       
