...
<strong class="empresa">Habilidades, experiencia específica de acuerdo al área laboral</strong></h3>
...
<div class="campo_pop derecha2">
	...
	<span>Habilidad: <input type ="text" name="conocimiento" id="conocimiento" maxlength="50" size="50" /></span>
...
<br><br><br>
      ...
      <% 
       ArrayList<RequisitoVO> lista=(ArrayList<RequisitoVO>) (request.getSession().getAttribute("listaHabilidades")!=null?request.getSession().getAttribute("listaHabilidades"):new ArrayList<RequisitoVO>());
   ...
   <br><br>
	...
	<tr>
	<td>
     <input type="button" value="Guardar" class="boton" onclick="doSubmit('registrarHabilidades');"/>
     </td>
     <td>
