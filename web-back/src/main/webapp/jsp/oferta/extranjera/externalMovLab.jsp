...
<script type="text/javascript">
  ...
  function doSubmitPager(method) {
      ...
      dojo.xhrPost({url: 'ofertasExtranjeras.do', form:'OfertasRecientesForm', timeout:180000, 
                    load: function(data) {
  ...
  function mostrarTodas(tipo, totReg) {
	...
	function doSubmitPagina(pagina, dif){
	   	...
	   	dojo.xhrPost({url: 'ofertasExtranjeras.do?method=goToPage&goToPageNumber='+pagina, timeout:180000, 
...
<div class="row">
    ...
    <form name="OfertasRecientesForm" id="OfertasRecientesForm" action="ofertasExtranjeras.do" method="post">       
