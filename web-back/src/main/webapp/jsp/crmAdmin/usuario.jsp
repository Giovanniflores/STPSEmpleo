                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <br/>
                                <html:form styleClass="form-horizontal form-label-left" action="/crmAdmin/createUsuario.do">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <html:text  styleId="usuario" property="usuario" styleClass="form-control" ></html:text>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <html:text styleId="Clave" property="clave" styleClass="form-control"></html:text>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <html:text styleId="Correo" property="correo" styleClass="form-control"></html:text>
...
<script type="text/javascript">
    window.onload = function() {
        document.crmUsuarioForm.action = "createUsuario.do";
    }
