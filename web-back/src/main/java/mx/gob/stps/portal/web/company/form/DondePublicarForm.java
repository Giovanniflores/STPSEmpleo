...
public class DondePublicarForm extends DomicilioForm implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 9183839239405775971L;

	private static Logger logger = Logger.getLogger(DondePublicarForm.class);
