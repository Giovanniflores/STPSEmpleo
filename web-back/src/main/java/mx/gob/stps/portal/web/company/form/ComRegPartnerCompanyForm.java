...
public class ComRegPartnerCompanyForm extends DomicilioForm implements Serializable{
	private static final long serialVersionUID = 973115287043851867L;

	private static Logger logger = Logger.getLogger(ComRegPartnerCompanyForm.class);
	...
	//private List<TerceraEmpresaVO> lstTerceras = new ArrayList<TerceraEmpresaVO>();
	...
	public void reset() {
		...
		entreCalle = null;
		yCalle = null;
		//COMENTAR EN PRODUCCION idTerceraEmpresa = 0;		
		//COMENTAR EN PRODUCCION TODO:domicilio = null;			
		//COMENTAR EN PRODUCCION TODO:lstTelefonos = null;		
		//COMENTAR EN PRODUCCION TODO:preCorreoElectronico = null;		
	}
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
		...
		//COMENTAR EN PRODUCCION
		//if(method.equalsIgnoreCase("salvar") || method.equalsIgnoreCase("editar")){
		...
		if(method.equalsIgnoreCase("salvar")){
			...
			if(selectPartnerCompany<=0){
				...
				System.out.println("Cambio de estatus selectPartnerCompany:" + selectPartnerCompany);
			}
	 ...
	 */
	/*public List<TerceraEmpresaVO> getLstTerceras() {
		return lstTerceras;
	}*/
	 ...
	 */
	/*public void setLstTerceras(List<TerceraEmpresaVO> lstTerceras) {
		this.lstTerceras = lstTerceras;
	}*/
