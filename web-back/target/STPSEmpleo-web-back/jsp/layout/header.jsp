		...
		<div id="wrapper">
	    	<div id="herramientas">
     		...
     		<div id="espacio_buscador">
         		<div id="buscador" class="ac_2011 b">
         			...
         			<div class="swb-ilta" id="ilta_31">235,000</div>
               		<form name="ocp" id=ocp" action="<%=swb %>/es_mx/empleo/Ocupate" method="get">
 						<input type="hidden" name="method" value="init" />
 						<input type="hidden" name="searchQ" value="" />
 						<div class="que_empleo">
 							<p class="t_buscador"><label for="searchTopic">¿Qué empleo buscas?</label></p>
 							<p class="buscador_1"><input name="searchTopic" id="searchTopic" type="text" value="" /></p>
 						...
 						<div class="donde">
  							<p class="t_buscador"><label for="searchPlace">¿Dónde?</label></p>
							<ul id="combo">
								<li class="texarea">
  									<span id="spryselect1">
			...
			<div id="cuerpo_int">
        		...
        		<div id="contenido_principal" class="sinCol">
        			<div id="ruta_navegacion">Estás en: <a href="https://www.empleo.gob.mx"  >Inicio</a> | Herramientas del sitio | <a href="<%=swb %>/es_mx/empleo/Inscripcion_al_portal_y_login"  >Inscripción al portal y login</a> | Registro de Empresa&nbsp;&nbsp;
        			...
        			<div id="contenido" class="frames">  
						...
						<div id="contenido_principal">
							<jsp:include page="/jsp/company/registro/preregistro_empresa.jsp"/>
						</div>
        			</div>      
    			</div>
        	</div>
