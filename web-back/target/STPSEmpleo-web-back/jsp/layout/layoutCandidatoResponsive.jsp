...
String descripcion = descripcionPagina!=null ? descripcionPagina : "Secretaria del trabajo y previsi&oacute;n Social, Servicio Nacional de Empleo, Portal del Empleo.";
...
<tiles:insert page="/jsp/layout/templateCandidatoEmptyResponsive.jsp"
	flush="true">
