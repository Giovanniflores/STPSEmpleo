...
<t:publicTemplate>
	...
	<jsp:attribute name="descripcionRedSocial">
		Detalle de la oferta. Ingeniero Eléctrico
	</jsp:attribute>
	<jsp:body>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="page-header">
				<h3>Detalle de la oferta <small>Ingeniero Eléctrico</small></h3>
			</div>
		</div>
						...
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>Grado Universitario en Ingeniería Eléctrica.</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>Inglés – mínimo B2, idiomas adicionales son muy buenos.</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>Experiencia en Trabajo previo a la especialización.</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="panel panelOfferDetalle">
								<div class="panel-body">
									...
									<span>Habilidades diversas dependiendo de las tareas y actividades.</span>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
...
Inicio de contrato: Tan pronto como sea posible.
				...
				<div class="col-sm-12">
					...
					<div class="panel panelOfferOdd">
						<div class="panel-body">Las Compañías en esta área son: Electrónica, Computadoras Digitales, Ingeniería de Encendido, Telecomunicaciones, Control de Sistemas, Ingeniería en Radio Frecuencia, Procesamiento de señales, Instrumentación, Microelectrónica.</div>
					</div>
					<div class="panel panelOffer">
						<div class="panel-body">Ingeniería en Hardware.</div>
					</div>
					<div class="panel panelOfferOdd">
						<div class="panel-body">Electrónica de Encendido.</div>
					</div>
					<div class="panel panelOffer">
						<div class="panel-body">Electromagnética y Ondas.</div>
					</div>
					<div class="panel panelOfferOdd">
						<div class="panel-body">Ingeniería en Microondas.</div>
					</div>
					<div class="panel panelOfferOdd">
						<div class="panel-body">Nanotecnología.</div>
					</div>
					<div class="panel panelOfferOdd">
						<div class="panel-body">Energía renovable.</div>
					</div>
					<div class="panel panelOfferOdd">
						<div class="panel-body">Mecatrónica.</div>
					</div>
					<div class="panel panelOfferOdd">
						<div class="panel-body">Ciencia en materiales eléctricos.</div>
					</div>
					<div class="panel panelOfferOdd">
						<div class="panel-body">Trabajar con herramientas y equipo que difiera de la  ingeniería dependiendo del área exacta de actividad y función.</div>
					</div>
				</div>
				<div class="col-sm-12">
					<div class="panel panelOfferDetalle">
