...
<t:publicTemplate>
	<jsp:attribute name="titulo">Capacitaci&oacute;n para el autoempleo (B&eacute;cate)</jsp:attribute>
    ...
    <div class="row">
      <div class="col-sm-12">
        <ol class="breadcrumb">
          ...
          <li class="active">Capacitación para el autoempleo</li>
        </ol>
      </div>
    </div>
    <!-- /div ruta_navegacion -->
        ...
        <div class="clearfix"></div>
		 ...
		 <div class="panel">
          <div class="panel-body">
			<h2 class="titulosh2">Capacitación para el autoempleo</h2>
