...
<form name="domicilioForm" id="domicilioForm" method="post" action="domicilio.do" dojoType="dijit.form.Form">
	...
	<div id="registro_empresa">
        ...
        <p class="entero">
        <span class="un_medio"><strong><label for="codigoPostal">Código postal</label>*</strong></span>
        <span class="un_medio">
        ...
        <p class="entero">
        <span class="un_medio"><strong><label for="pais">País</label></strong></span>
        <span class="un_medio">
        ...
        <p class="entero">
        <span class="un_medio"><strong><label for="numeroExterior">Número exterior</label>*</strong></span>
        <span class="un_medio">
        ...
        <p class="entero">
        <span class="un_medio"><strong><label for="numeroInterior">Número interior</label></strong></span>
        <span class="un_medio">
