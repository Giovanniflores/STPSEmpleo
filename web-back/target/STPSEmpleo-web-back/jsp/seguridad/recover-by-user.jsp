...
<script type="text/javascript">
	...
	function mostrarDatos() {
		if (dijit.byId('correo').value != '') {
			if (dijit.byId('correo').value == dijit.byId('usuario').value) {
	...
	<div class="miEspacio formApp">
		...
		<div class="col-md-5" style="float:none;margin:auto;text-align:center">
			...
			<div class="row">
				<div class="col-md-12">
					<input type="text" name="correo" id="correo" size="40" maxlength="65" dojoType="dijit.form.ValidationTextBox" class="form-control"
						required="true" regExp="${regexplogin}" invalidMessage="Usuario no válido, verificar captura." missingMessage="El usuario es requerido."/>
					<p>&nbsp;</p>
				</div>
			</div>
			...
			<div class="form_nav"><p>&nbsp;</p>
				<input type="button" id="btnAceptar" value="Aceptar" class="boton_naranja  bt_grande" onclick="javascript:mostrarDatos();" /> 
