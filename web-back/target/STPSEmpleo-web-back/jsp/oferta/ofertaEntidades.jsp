...
<form name="entidadesFormBean" action="ofertaRegistroEntidades.do"
...
<table class="offer">
	<tr>
		<td><label for="entidadFederativaSelect">Entidad federativa</label>
		...
		<td><label for="municipioSelect">Municipio</label> <input type="hidden" name="municipio"
