...
<script type="text/javascript">
    ...
    function validaDatos(){       
    	...
    	if(document.registroUbicacionFormBean.idMunicipio.value=="-1")
		{
			document.registroUbicacionFormBean.codigoPostal.focus();
			mensaje("El siguiente campo muestra datos invalidos: Domicilio, Municipio.");
			return false;
    	...
    	if(document.registroUbicacionFormBean.idColonia.value=="-1")
		{
			document.registroUbicacionFormBean.codigoPostal.focus();
			mensaje("El siguiente campo muestra datos invalidos: Domicilio, Colonia.");
			return false;
...
<form name="registroUbicacionFormBean" id="registroUbicacionFormBean" action="ofertaEdicion.do" method="post">
    ...
    <span>Área laboral* 
				...
				<select dojotype="dijit.form.FilteringSelect" store="areaStore" id="areaSelect" required="true" style="width: 626px" missingMessage="Dato requerido">
    			</select> 
	                     </span>  </div>
    ...
    <input type="hidden" name="ocupacion" id="ocupacion" value="-1" />
				...
				<select dojotype="dijit.form.FilteringSelect" store="ocupacionStore" id="ocupacionSelect" required="true"  style="width: 626px" missingMessage="Dato requerido">
    </select></span> 
    </div>
   ...
   <div class="entero">
    ...
    <div class="entero">
        ...
        <input id="codigoPostal" name="codigoPostal" maxlength="5" size="5" value="${domicilio.codigoPostal}"
        	dojoType="dijit.form.ValidationTextBox" required="true" regExp="^[0-9]{1,5}"   missingMessage="Dato requerido"
...
<div class="entero">
   				<span class="un_tercio">
	   				<strong>Entidad federativa*</strong><br />
						...
						<select dojotype="dijit.form.FilteringSelect" store="entidadFederativaStore" id="idEntidadSelect" required="true" disabled="disabled" autoComplete="false" missingMessage="Dato requerido"></select>
   				</span>
   				<span class="un_tercio">
	   				<strong>Municipio*</strong><br />
						...
						<select dojotype="dijit.form.FilteringSelect" store="municipioStore" id="idMunicipioSelect" required="true" disabled="disabled" autoComplete="false" missingMessage="Dato requerido"></select>				        
   				</span>
   				<span class="un_tercio">
	   				<strong>Colonia*</strong><br />
						...
						<select dojotype="dijit.form.FilteringSelect" store="coloniaStore" id="idColoniaSelect" required="true" disabled="disabled" autoComplete="true" missingMessage="Dato requerido"></select>
   				</span>   				
   			</div>
      ...
      <div class="entero">
       ...
       <strong>Número exterior*</strong><br>
        <input id="numeroExterior" name="numeroExterior" maxlength="50" size="4" value="${domicilio.numeroExterior}"
        	dojoType="dijit.form.ValidationTextBox" required="true" regExp="^[\w\s]{1,50}" missingMessage="Dato requerido"
      ...
      <div class="entero">
        ...
        <input id="entreCalle" name="entreCalle" maxlength="150" size="60" value="${domicilio.entreCalle}" onBlur="cambiarMayusculas(this)"
        	dojoType="dijit.form.ValidationTextBox" required="true" regExp="^[\w\D\s\.áéíóúÁÉÍÓÚñÑ]{1,150}$" missingMessage="Dato requerido"
        	invalidMessage="Dato Invalido" missingMessage="Dato requerido" trim="true"/>
        </span>
  ...
  <div class="entero">
   <span class="un_tercio">
		...
		<select dojotype="dijit.form.FilteringSelect" store="entidadFederativaStore2" id="idEntidadSelect2" required="true" disabled="disabled" autoComplete="false" missingMessage="Dato requerido"></select>
      </span>
      <span class="un_tercio">
		...
		<select dojotype="dijit.form.FilteringSelect" store="municipioStore2" id="idMunicipioSelect2" required="true" disabled="disabled" autoComplete="false" missingMessage="Dato requerido"></select>				        
      </span>
    	 ...
    	 var entidadV = ${entidad1.entidad};
    		...
    		dojo.connect(dijit.byId("idEntidadSelect2"), "onChange", function() {
    			...
    			document.registroUbicacionFormBean.flagEntidad2.value="1";
    				...
    				var vEntidad2 = dijit.byId('idEntidadSelect2').get('value');
    				
    				
    		    	dijit.byId('idMunicipioSelect2').disabled=false;
    		    		
    		    	municipioStore2.url = "${context}domicilio.do?method=obtenerMunicipio" + "&" + "idEntidad="+ vEntidad2;
    		    	municipioStore2.close();
