	...
	if(document.requisitosFormBean.conocimiento.value != "" ){
		if(document.requisitosFormBean.experiencia.value=="-1")
		 {  document.requisitosFormBean.experiencia.focus();
  			mensaje("El siguiente campo muestra datos invalidos: Experiencia.");
  			return false;
		 }
		if(document.requisitosFormBean.dominio.value=="-1")
		 {  document.requisitosFormBean.dominio.focus();
  			mensaje("El siguiente campo muestra datos invalidos: Dominio.");
  			return false;
		 }
	}
	return true;
...
<body class="claro">
 ...
 <form name="requisitosFormBean" id="requisitosFormBean" action="ofertaEdicionExperiencia.do" method="post" >
...
<strong class="empresa">Conocimientos, experiencia específica de acuerdo al área laboral</strong></h3>
...
<div class="campo_pop derecha2">
	...
	<span>Conocimiento: <input type ="text" name="conocimiento" id="conocimiento" maxlength="50" size="50"  /></span>
	<span>Experiencia: <select name="experiencia" id="experiencia" >
  ...
  <br><br><br>
       ...
       <% 
       ArrayList<RequisitoVO> lista=(request.getSession().getAttribute("listaConocimientos")!=null?(ArrayList<RequisitoVO>) request.getSession().getAttribute("listaConocimientos"):new ArrayList<RequisitoVO>());
       RequisitoVO item=null;
       String nombreCheck;
       for(int i=0;i<lista.size();i++){
    	   item=(RequisitoVO)lista.get(i);
   ...
   <br><br>
	...
	<tr>
	<td>
     <input type="button" value="Guardar" class="boton" onclick="doSubmit('registrarConocimiento');"/>
     </td>
     <td>
