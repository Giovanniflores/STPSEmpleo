...
<form name="regContForm" id="regContForm" method="post" action="regCont.do" dojoType="dijit.form.Form">
	...
	<DIV>
    	<DIV class="entero">
	    	<span class="un_medio">
	    	<strong><label for="selectContactos">Contactos registrados - Estatus</label></strong><br>
	...
	<strong><label for="nombreContacto">Nombre(s)</label>*</strong>
	...
	<DIV class="entero">  
	<span class="un_tercio">     			   
	<strong><label for="entidadFederativaSelect">Entidad federativa</label>*</strong><br>
	...
	<span class="un_tercio">
	<strong><label for="municipioSelect">Municipio</label>*</strong><br>
	...
	<span class="un_tercio">
	<strong><label for="coloniaSelect">Colonia</label>*</strong><br>
	...
	<h4>Teléfono*</h4>       		
	<DIV class="entero">  
	<span class="un_quinto"><strong><label for="idTipoTelefono">Tipo de teléfono</label>*</strong><br>
	<%
	...
	<span class="un_quinto"><strong> <label for="acceso">Acceso</label>*</strong><br>
	...
	<span class="un_quinto"><strong><label for="clave">Clave Lada</label>*</strong><br>  
	<input id="clave" name="clave" maxlength="3" size="3"
		dojoType="dijit.form.ValidationTextBox" required="true" regExp="^[0-9]{2,3}$"
		invalidMessage="Dato Invalido" missingMessage="Dato requerido" trim="true" />	        			        
	</span> 			 
	<span class="un_quinto"><strong><label for="telefono">Teléfono</label>*</strong><br>
	...
	<span class="un_quinto"><strong><label for="extension">Extensión</label> </strong><br>
