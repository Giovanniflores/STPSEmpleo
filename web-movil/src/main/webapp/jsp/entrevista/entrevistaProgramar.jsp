...
<html>
	...
	<script language="JavaScript" type="text/javascript">
		...
		function doSubmit(){
			if(validar72hr()){
			document.entrevistaEmpresaForm.method.value='programarEntrevista';
...
<body>
	...
	<form id="entrevistaEmpresaForm" name="entrevistaEmpresaForm" method="post" action="entrevistaProgramada.m">
		...
		<input type="hidden" id="idOferta" name="idOferta" value="${entrevistaProgramadaForm.idOferta}">
		...
		<div dojoType="dojox.mobile.RoundRect" >
			<div style="text-align: center;" class="titNar">Programar entrevista</div>
			<div class="mblVariableHeight" style="font-size: small;">
				<b>Oferta:</b>    ${entrevistaProgramadaForm.tituloOferta}<br/>
				<b>Candidato:</b> ${entrevistaProgramadaForm.nombreCandidato}<br/>
				<b>Fecha:</b>     <input type="text" id="fecha" name="fechaEntrevista" readOnly value="" onclick="showCal(this)" ><br/>
				<b>Hora:</b>      <input type="text" id="hora" name="horaEntrevista" readOnly value="" onclick="showTimer(this)">
			</div>
		</div>
